...
- [ ] Next: T2-7 / T3-3 / T3-4 / T3-6 / T3-7 (5 remaining); T5-8 loop when backlog empties. Open repair flag: `meta_harness_development_self_evaluation.md` unindexed (warning) — index into meta_harness META.md or remove, when convenient.
