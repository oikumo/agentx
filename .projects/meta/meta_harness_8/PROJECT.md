...
- [ ] Next: T5-4 2D (`two worker capacity scope arbitration`, strict T5 slice order); T3-4 benchmark anytime (no policy change); T5-8 loop when backlog empties. Open repair flag: `meta_harness_development_self_evaluation.md` unindexed (warning) — index into meta_harness META.md or remove, when convenient.
