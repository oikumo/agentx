...
<USER_COMMAND_EXTENSION>: In [## User Commands Extension]() (file: "/.project_development/USER_COMMAND_EXTENSION.md")
<PROJECT_NAVIGATION>: In [## Project Navigation]() (file: "/.project_development/PROJECT_NAVIGATION_ROUTES.md")
<PROJECT_DOCUMENTATION>: In [## Project Documentation]() (file: "/.project_development/PROJECT_DOCUMENTATION.md")
<PROJECT_TESTING_SANDBOX_RULES>: In [## Project Testing Sandbox Rules]() (file: "/.project_development/PROJECT_TESTING_SANDBOX_RULES.md")
<PROJECT_ROADMAP>: In [## Project Roadmap]() (file: "/.project_development/PROJECT_ROADMAP.md")
<TAKS_TYPES>: In [## Tasks Types]().
<CURRENT_ISSUE>: In [## Current Issue]() (file: "/.project_development/CURRENT_ISSUE.md")
...
<USER_COMMAND>
  <NAME>+</NAME>
  <ARGUMENTS></ARGUMENTS>
  <ACTION>List all User Commands in [<USER_COMMANDS>]() and [## User Commands Extension]() (file: "/.project_development/USER_COMMAND_EXTENSION.md"), include a description. Format it in a simple .MD table</ACTION>
</USER_COMMAND>
...
<DESCRIPTION>
User Command extensión in file "/.project_development/USER_COMMAND_EXTENSION.md"
</DESCRIPTION>
</USER_COMMAND_EXTENSION>
...
<ACTION>
Use for know how to implement test following the rules in "/.project_development/PROJECT_TESTING_SANDBOX_RULES.md" file
</ACTION>
</PROJECT_TESTING_SANDBOX_RULES>
...
<PROJECT_NAVIGATION>
<DESCRIPTION>
MAP TO UNDERSTAND AND NAVIGATE QUICKLY THROUGH THE SOURCE CODE IS IN "/.project_development/PROJECT_NAVIGATION_ROUTES.md" file
</DESCRIPTION>
<ACTION>
Inspect and make changes but first look in the /.project_development/PROJECT_NAVIGATION_ROUTES.md file
</ACTION>
</PROJECT_NAVIGATION>
...
<DESCRIPTION>
Project full documentation. Documentation maps folder content in "/.project_development/PROJECT_DOCUMENTATION.md" file
</DESCRIPTION>
<ACTION>
Check the documentation "/.project_development/PROJECT_DOCUMENTATION.md" file to navigate in the project documentation, when you need more detailed information
</ACTION>
<PROJECT_DOCUMENTATION>
...
<PROJECT_ROADMAP>
<DESCRIPTION>
Project new features and improvements. Centralized in the "/.project_development/PROJECT_ROADMAP.md" file
</DESCRIPTION>
<ACTION>
...
<CURRENT_ISSUE>
<DESCRIPTION>
Describe the current issue, active and need to be solved in the "/.project_development/CURRENT_ISSUE.md" file. If is not exists any issue "/.project_development/CURRENT_ISSUE.md" file, must be set EMPTY 
</DESCRIPTION>
<ACTION>
Put the current issue and current issue solving strategy in "/.project_development/CURRENT_ISSUE.md" file. If is not exists any issue "/.project_development/CURRENT_ISSUE.md" file, must be set EMPTY
</ACTION>
<CURRENT_ISSUE>
