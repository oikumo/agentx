...
AGENTS_BUDGET = 3584             # rides the system prompt EVERY turn (F33; improvement004/OPT-A: §12/TDD/NAV/THINK/QuickRef tables → nav pointers — .omt @budget agents_md=3584 is the source of truth; 2026-08-08: 2560→2816 to add .projects/ component line; feature_049/session_start_menu: 2816→2944 for STARTUP Tasks-menu line D19; 2026-09-20 git remote-only rule change: 2944→3072 for 7 remote-deny records; 2026-09-20 feature_120 startup token diet: 3072→3584 for STARTUP compiled-header + probe-brief line)
