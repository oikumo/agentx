...
class WebIngestionApp:
    ...
    async def run(self, site_url: str, result_json_file_path: str):
        print(f"map and extract from: {site_url}")
        print(f"generated document file path: {result_json_file_path}")
        ...
        print("DOCUMENTS CHUNKING PHASE")
