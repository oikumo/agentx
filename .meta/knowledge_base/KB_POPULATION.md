...
python3 .meta/tools/populate

# Or specify which KB
python3 .meta/tools/populate both    # Both KBs
python3 .meta/tools/populate meta    # Meta Harness KB only
python3 .meta/tools/populate agentx # agentx KB only
```
