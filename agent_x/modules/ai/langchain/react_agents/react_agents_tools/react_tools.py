...
from agent_x.modules.ai.langchain.react_agents.react_agents_tools.callbacks import AgentCallbackHandler
...
def get_text_length(text: str) -> int:
    ...
    length = len(text)
    print(f"tool get_text_length: {length}")
...
def react_tools(llm: BaseLanguageModel):
    ...
    llm.callbacks = [AgentCallbackHandler()]
